    ...
    <body>
            ...
            <div class="centro ">
                <div class="grid">
                    ...
                    <div class="item"> <a class="a1" href="bolsillo?accion=inicio_dp">MENU</a> </div>
                     <!-- division de grid con ruta de servlet con la accion de retiarar ( redirige a la vista recagar.jsp en el servlet  )  -->
                    <div class="item"> <a class="a1" href="bolsillo?accion=retirar">SACAR DINERO</a> </div>
                    ...
                    <div class="item"> <a class="a1" href="bolsillo?accion=consultar_saldo"> CONSULTAR SALDO</a> </div>
                </div>
            </div> 
