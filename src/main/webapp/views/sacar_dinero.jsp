...
<!-- contenidos de el header -->
  ...
  <div class="centro">
   <div class="grid">
    ...
    <div class="item"><a href="bolsillo?accion=inicio_dp">MENU</a>   </div>
    ...
    <div class="item"> <a href="bolsillo?accion=consultar_saldo">CONSULTAR SALDO</a> </div>
     <!-- division de grid con ruta de servlet con la accion de recargar   ( redirige a el la vista recargar.jsp en el servlet  )  -->
    <div class="item"> <a href="bolsillo?accion=recargar"> RECARGAR</a> </div>
